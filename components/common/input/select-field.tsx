...
const SelectField: FC<Props> = ({
  ...
  return (
    <div className={cn('relative w-[200px]', className)}>
      <header className="bg-white border-2 border-gray-600 focus:border-brand p-2 flex items-center">
        <input
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            {loading && (
              <BiLoaderAlt className="mx-auto max-w-fit animate-spin text-brand" />
            )}
